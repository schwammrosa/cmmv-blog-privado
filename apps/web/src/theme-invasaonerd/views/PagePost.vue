        ...
        <div class="lg:max-w-4xl md:max-w-3xl mx-auto pt-0">
            ...
            <div v-else class="article-container w-full max-w-[1060px] m-auto bg-white rounded-lg lg:p-6 lg:pt-[40px]">
                <div class="w-full mx-auto overflow-hidden">
                    ...
                    <!-- Post Header -->
                    <header class="post-header my-6 px-2 mb-0">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="flex gap-2 flex-wrap">
                                        ...
                                        <a class="bg-green-500 hover:bg-green-600 w-8 h-8 rounded-full flex items-center justify-center text-white transition-colors"
                                            ...
                                            data-action="share/whatsapp/share" title="Compartilhar no WhatsApp">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                                fill="currentColor">
                                                <path
                    ...
                    <!-- Author Box -->
                    <div v-if="author"
                        class="mb-10 p-6 bg-neutral-50 rounded-lg border border-neutral-200 px-2 mx-2">
