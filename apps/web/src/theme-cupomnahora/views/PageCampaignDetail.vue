        ...
        <div class="w-full max-w-[1200px] mx-auto px-4 py-8">
            ...
            <div v-else class="bg-white rounded-lg p-6">
                <div class="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
                    <div class="w-[240px] h-[188px] flex-shrink-0 flex items-center justify-center bg-gray-100 rounded-lg overflow-hidden">
                        <img v-if="campaign.logo" :src="campaign.logo" :alt="campaign.name" class="w-full h-full" width="240" height="188">
