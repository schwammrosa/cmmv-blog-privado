                                    ...
                                    <div v-if="post.featureImage" class="post-featured-image relative overflow-hidden rounded-lg max-h-[400px]">
                                        <div class="absolute top-4 left-4 z-10 flex flex-wrap gap-2">
                                            <a v-for="category in post.categories" :key="category.id" :href="`/category/${category.slug}`"
                                                class="px-3 py-1 bg-[#00A079] text-white text-sm font-medium rounded-full shadow-sm hover:bg-[#064019] transition-all">
                                                {{ category.name }}
                                            </a>
                                        </div>
                                    ...
                                    <header class="post-header my-6">
                                        <div class="post-meta flex items-center">
                                            ...
                                            <div class="post-status ml-4" v-if="post.status !== 'published'">
                                                <span class="bg-[#00B8D4] text-[#333333] px-2 py-1 rounded-full text-xs font-semibold">{{ post.status?.toUpperCase() }}</span>
                                            </div>
                                        </div>
                                    </header>
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        >
                                            <div class="w-24 h-20 flex-shrink-0 overflow-hidden rounded-lg shadow-sm">
                                                <a :href="`/post/${popularPost.slug}`" class="block h-full">
                                                    <img
                                            ...
                                            <div class="flex-grow">
                                                <a :href="`/post/${popularPost.slug}`" class="block group">
                                                    <h4 class="text-sm font-semibold text-gray-800 group-hover:text-[#00B8D4] transition-colors line-clamp-2">
                                                        {{ popularPost.title }}
                                                    </h4>
                                                </a>
...
.post-content :deep(.source-attribution a:hover) {
    text-decoration: underline;
}
</style>
